...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, fUtensils } from '@fortawesome/free-solid-svg-icons'
...
const DefaultLayout: React.FC<{
    ...
    function getMenu(): MenuProps['items'] {
        ...
        menu.push({
            key: '/restaurant',
            label: 'Restaurant',
            icon: <FontAwesomeIcon icon={faUtensils}></FontAwesomeIcon>,
